...
title: Prompt Engineering — Guía Complementaria
...
- **Técnicas de prompting** (Zero-shot, Few-shot, CoT): Ver [Dominio 3](/docs/readiness-path/dominio-3#2-técnicas-efectivas-de-ingeniería-de-prompts)
- **Parámetros de inferencia** (resumen): Ver [Dominio 2](/docs/readiness-path/dominio-2#parámetros-de-inferencia---aleatoriedad-y-diversidad)
  :::
...
:::warning
Ambos parámetros deben elegirse según la tarea. Configuraciones incorrectas causan salidas incompletas o excesivas.
:::
...
:::note Ver también
[Dominio 3 - Instrucciones adversarias](/docs/readiness-path/dominio-3#técnicas-comunes-de-instrucciones-adversarias)
:::
