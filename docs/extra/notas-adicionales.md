...
title: Notas Adicionales — AWS AI Practitioner
...
| **MAPE** (Mean Absolute Percentage Error) | Error porcentual. Útil para comparar entre datasets.             |
| **RMSE** (Root Mean Square Error)         | Penaliza errores grandes. Misma unidad que la variable objetivo. |
...
| ------------------------- | ----------------------------------------------- | ----------------------------------------------- |
| **Precision**             | TP / (TP + FP)                                  | Cuando FP son costosos (ej: spam, fraude)       |
| **Recall** (Sensibilidad) | TP / (TP + FN)                                  | Cuando FN son costosos (ej: diagnóstico médico) |
...
> **Nota:** Este documento complementa las notas de los Dominios 1-5 en Readiness Path. Para temas como RAG, Fine-tuning, RLHF y Prompt Engineering, consultar las notas originales.
