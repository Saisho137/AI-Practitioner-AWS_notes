---
id: dominio-4
title: "Dominio 4: Directrices para IA Responsable"
sidebar_label: "D4 · IA Responsable (14%)"
sidebar_position: 4
---
...
![Underfitting vs Overfitting](<dominio_4_images/Underfitting (subajuste).png>)
...
![Ciclo de vida del modelo ML responsable](<dominio_4_images/A bordo.png>)
...
![Amazon Augmented AI](<dominio_4_images/Pasted Graphic 5.png>)
...
:::tip Nota clave
Clarify se asocia a **"Sesgo"**
:::

![SageMaker Clarify - Identificación de sesgos](<dominio_4_images/Identifica desequilibrios en los datos.png>)
...
:::tip Nota clave
Model Monitor se asocia a **"Desviaciones"** (o varianza)
:::

![SageMaker Model Monitor](<dominio_4_images/• Monitorea.png>)
...
![Funciones de gobierno en Amazon SageMaker](<dominio_4_images/Amazon SageMaker.png>)
...
![SageMaker Model Dashboard](<dominio_4_images/bactena problemas de.png>)
...
![Transparencia, Interpretabilidad y Explicabilidad](<dominio_4_images/Transparencia, Interpretabilidad y Explicabilidad.png>)
...
![Diseño centrado en el ser humano](<dominio_4_images/Construir un equipo.png>)
