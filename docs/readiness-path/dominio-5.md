---
id: dominio-5
title: "Dominio 5: Seguridad, Cumplimiento y Gobernanza"
sidebar_label: "D5 · Seguridad y Gobernanza (14%)"
sidebar_position: 5
---
...
Este dominio representa el **14%** del examen AWS Certified AI Practitioner.
:::
...
### Importancia de la Gobernanza y el Cumplimiento
...
![Consideraciones de seguridad para sistemas de IA](<dominio_5_images/Detección de amenazas.png>)
...
![AWS IAM - Control de acceso](<dominio_5_images/Usuario de.png>)
...
## 2. Regulaciones de Gobernanza y Cumplimiento

### Cumplimiento de los Estándares de IA

<!-- Imagen de estándares de cumplimiento no disponible en el repositorio -->
...
![Estrategia de defensa en profundidad](<dominio_5_images/Politicas, procedimientos y conocimiento.png>)
...
### Servicios AWS para Proteger los Sistemas de IA
...
![Matriz de alcance de seguridad](<dominio_5_images/picatón pre.png>)
...
![Principios de IA Responsable](<dominio_5_images/IA Responsable.png>)
...
![Infraestructura segura para IA](<dominio_5_images/Infraestructura de.png>)
...
![Pregunta sobre IA responsable en modelos ML](<dominio_5_images/IA responsable en modelos ML.png>)
...
![Pregunta sobre acceso a FMs en Bedrock](<dominio_5_images/Acceso a FMs en Amazon Bedrock.png>)
...
![Pregunta de correspondencia de servicios](<dominio_5_images/Pregunta coincidente.png>)
